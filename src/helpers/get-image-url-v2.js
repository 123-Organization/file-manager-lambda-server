...
const getImageUrlV2 = (libraryType, fileNames, imageType, accountKey = "") => {
    ...
    if (imageType == 'thumbnail') {
      return `${folderName}/thumbnail/200x200_${imageName}`;
    }
    if (imageType == 'original') {
      return `http://${bucketName}.s3.us-east-1.amazonaws.com/${folderName}/${imageName}`;
    }
    if (imageType == 'preview') {
      return `${folderName}/preview/${imageName}`;
    }
  
}
module.exports = getImageUrlV2;